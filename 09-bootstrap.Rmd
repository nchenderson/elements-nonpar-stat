...
```{r, echo=FALSE, fig.cap="Histogram of simulated values of exp(sample mean) with density of the Normal approximation overlaid. This assumes n=50."}
...
```{r, echo=FALSE}
hist(boot.mean, breaks="FD", main="Bootstrap Distribution of Sample Mean", xlab="x", col="grey", las=1)
