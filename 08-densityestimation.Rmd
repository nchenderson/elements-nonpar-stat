...
plot(0,0, type="n", xlim=c(-5,5), ylim=c(0,.43), xlab="u", ylab="K(u)", las=1)
lines(tt, dnorm(tt), lwd=2)
legend("topleft", legend="Gaussian Kernel", bty='n', cex=1.5)
plot(0,0, type="n", xlim=c(-5,5), ylim=c(0,.43), xlab="u", ylab="K(u)", las=1)
lines(tt, epafn(tt), lwd=2)
legend("topleft", legend="Epanechnikov Kernel", bty='n', cex=1.5)
plot(0,0, type="n", xlim=c(-5,5), ylim=c(0,.43), xlab="u", ylab="K(u)", las=1)
lines(tt, bwfn(tt), lwd=2)
legend("topleft", legend="Biweight Kernel", bty='n', cex=1.5)
```
