...
* What is the bootstrap estimate for the sample mean?
...
\begin{eqnarray}
1 - \alpha &=& P\Big( -\sigma z_{1 - \alpha/2} \leq W_{n}(\mathbf{X}, \theta) \leq \sigma z_{1 - \alpha/2}) \nonumber \\
&=& P\Big(-\sigma z_{1 - \alpha/2} \leq \bar{X} - \theta \leq \sigma z_{1 - \alpha/2})  \nonumber \\
&=& P\Big(\bar{X} -\sigma z_{1 - \alpha/2} \leq \theta \leq \sigma z_{1 - \alpha/2})  \nonumber 
\end{eqnarray}
...
\begin{eqnarray}
1 - \alpha &=& P\Big( K^{-1}(\alpha/2) \leq T_{n} - \theta \leq K^{-1}(1 - \alpha/2) \Big)  \nonumber \\
&=& P\Big(  - se_{boot} \times K^{-1}(1 - \alpha/2)\leq \theta - T_{n} \leq -se_{boot} \times K^{-1}(\alpha/2) \Big)  \nonumber \\
&=& P\Big(T_{n} - se_{boot} \times K^{-1}(1 - \alpha/2), T_{n} - se_{boot} \times K^{-1}(\alpha/2) \Big)  \nonumber
\end{eqnarray}
