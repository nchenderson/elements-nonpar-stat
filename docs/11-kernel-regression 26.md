...
= \frac{1}{n}[\mathbf{m} - \mathbf{A}_{h_{n}}\mathbf{Y}]^{T}[\mathbf{m} - \mathbf{A}_{h_{n}}\mathbf{Y}]
\end{equation}

* If we apply the above Theorem to the vector $\mathbf{m} - \mathbf{A}_{h_{n}}\mathbf{Y}$, we can notice that
\begin{equation}
E\{ \frac{1}{n}( \mathbf{m} - \mathbf{A}_{h_{n}}\mathbf{Y} )^{T}(\mathbf{m} - \mathbf{A}_{h_{n}}\mathbf{Y}) \} = \frac{1}{n}[ (\mathbf{I} - \mathbf{A})\mathbf{m}]^{T}[(\mathbf{I} - \mathbf{A})\mathbf{m}] + \frac{\sigma^{2}}{n}\textrm{tr}(\mathbf{A}\mathbf{A}^{T})  \nonumber
\end{equation}
