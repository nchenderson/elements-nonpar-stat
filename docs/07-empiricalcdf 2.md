...
\begin{equation}
CI_{pw}(t) = \Big[ \hat{F}_{n}(t) - \frac{ z_{0.975} }{\sqrt{n \{ \hat{F}_{n}(t)(1 - \hat{F}_{n}(t)) \} }},
\hat{F}_{n}(t) + \frac{ z_{0.975} }{\sqrt{n \{ \hat{F}_{n}(t)(1 - \hat{F}_{n}(t)) \} }} \Big]
\end{equation}
...
```r
plot(kidney.Fhat, do.points=FALSE, verticals=TRUE, main = "Kidney Data:  ecdf without points and vertical lines added", las=1)
```
...
* Discuss confidence intervals here
...
lines(tt, ci.low, type="s")
lines(tt, ci.upper, type="s")
```
