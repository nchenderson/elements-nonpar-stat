...
``` r
oneserow <- full_tree$nsplit[full_tree$cptable[,"xerror"] <= onese_thresh]
print(oneserow)
```
...
```
##        CP    nsplit rel error    xerror      xstd 
##  0.356390  0.000000  1.000000  1.000266  0.017871
```
...
```
##         hr        day       mnth      atemp       temp     season        hum 
## 94218293.0 53899163.6 24064245.5 23044193.5 22971879.1 19322607.5 12179199.6 
## workingday    weekday  windspeed weathersit    holiday 
## 10937043.8  5979257.6  1403600.3   926380.4   265086.8
```
