...
## 1 0.3564      0    1.0000 1.0003 0.0179
## 2 0.1811      1    0.6436 0.6438 0.0129
## 3 0.1088      2    0.4625 0.4791 0.0097
## 4 0.0352      3    0.3537 0.3688 0.0077
## 5 0.0260      4    0.3185 0.3564 0.0073
## 6 0.0245      5    0.2925 0.3434 0.0073
## 7 0.0150      7    0.2435 0.2878 0.0065
## 8 0.0136      8    0.2286 0.2660 0.0063
```
...
```
##        CP    nsplit rel error    xerror      xstd 
##    0.0002  155.0000    0.0404    0.1256    0.0049
```
...
best_tree <- rpart(bikers ~ ., data = Bikeshare, 
...
``` r
oneserow <- sum(full_tree$cptable[,"xerror"] > onese_thresh)
round(full_tree$cptable[oneserow,], 6)
```

```
##          CP      nsplit   rel error      xerror        xstd 
##    0.000000 1998.000000    0.005291    0.131506    0.005323
```
...
onese_tree <- rpart(bikers ~ ., data = Bikeshare, 
...
* If we set $\alpha = 0.0085$, this will give us a tree with $9$ terminal nodes.

``` r
short_tree <- rpart(bikers ~ ., data = Bikeshare, 
                   control = rpart.control(cp = 0.0085, minsplit = 5))
```

<img src="14-cart_files/figure-html/unnamed-chunk-18-1.png" alt="" width="672" />

* Plotting this short decision tree suggests that `registered` is a **very important covariate**.
...
```
##   registered       casual           hr         temp        atemp          day 
## 1.437274e+08 5.176012e+07 4.308696e+07 1.294643e+07 1.096124e+07 1.058517e+07 
##          hum   workingday      weekday         mnth       season    windspeed 
## 2.375712e+06 1.981920e+06 1.211897e+06 4.410285e+05 2.654503e+04 7.410813e+03 
##      holiday 
## 4.204419e+03
```


<img src="14-cart_files/figure-html/unnamed-chunk-20-1.png" alt="" width="672" />
