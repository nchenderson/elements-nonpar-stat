...
```
##        CP    nsplit rel error    xerror      xstd 
##    0.0000  737.0000    0.0003    0.0048    0.0002
```
...
```
##        CP    nsplit rel error    xerror      xstd 
## 3.000e-06 3.130e+02 8.020e-04 4.991e-03 2.060e-04
```
...
<img src="14-cart_files/figure-html/unnamed-chunk-16-1.png" alt="" width="672" />
