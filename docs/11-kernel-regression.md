...
* **bass** - tuning parameter to further control the smoothness of the fitted curve. Smallest value is $0$ (lowest level of smoothness). Largest value is $10$ (most smoothness).
