...
```{r, echo=FALSE}
wine <- read.csv("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/STAT685Notes/Data/wine.csv")
```
...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist(wine2$Magnesium[wine2$Type==1], xlab="Magnesium", main="Wine Type 1", las=1, col="lightgrey")
hist(wine2$Magnesium[wine2$Type==2], xlab="Magnesium", main="Wine Type 2", las=1, col="lightgrey")
par(mfrow=c(1,1))
...
```{r, echo=FALSE}
Meat <- read.csv("~/Library/Mobile Documents/com~apple~CloudDocs/Documents/STAT685Notes/Data/meat.csv")
```
