...
hist(eta.boot, breaks="FD", col="grey", xlab=expression(hat(eta)), main=expression(paste("Bootstrap replications of ", hat(eta)," for the shifted Exponential distribution")))
```
