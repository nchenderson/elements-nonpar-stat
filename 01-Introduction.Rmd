...
* Regression is a common way of modeling the relationship between two variables.
...
* One popular nonparametric approach is the use of splines (or local linear regression?)
