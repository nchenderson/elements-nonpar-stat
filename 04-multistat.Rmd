...
A[1,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="A"], InsectSprays$count[InsectSprays$spray=="B"], conf.int=TRUE,
                     warning=FALSE)$conf.int
A[2,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="A"], InsectSprays$count[InsectSprays$spray=="C"], conf.int=TRUE,
                     warning=FALSE)$conf.int
A[3,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="A"], InsectSprays$count[InsectSprays$spray=="D"], conf.int=TRUE,
                     warning=FALSE)$conf.int
A[4,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="A"], InsectSprays$count[InsectSprays$spray=="E"], conf.int=TRUE, 
                     warning=FALSE)$conf.int
A[5,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="A"], InsectSprays$count[InsectSprays$spray=="F"], conf.int=TRUE,
                     warning=FALSE)$conf.int
A[6,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="B"], InsectSprays$count[InsectSprays$spray=="C"], conf.int=TRUE,
                     warning=FALSE)$conf.int
A[7,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="B"], InsectSprays$count[InsectSprays$spray=="D"], conf.int=TRUE,
                     warning=FALSE)$conf.int
A[8,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="B"], InsectSprays$count[InsectSprays$spray=="E"], conf.int=TRUE,
                     warning=FALSE)$conf.int
A[9,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="B"], InsectSprays$count[InsectSprays$spray=="F"], conf.int=TRUE,
                     warning=FALSE)$conf.int
A[10,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="C"], InsectSprays$count[InsectSprays$spray=="D"], conf.int=TRUE,
                      warning=FALSE)$conf.int
A[11,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="C"], InsectSprays$count[InsectSprays$spray=="E"], conf.int=TRUE,
                      warning=FALSE)$conf.int
A[12,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="C"], InsectSprays$count[InsectSprays$spray=="F"], conf.int=TRUE,
                      warning=FALSE)$conf.int
A[13,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="D"], InsectSprays$count[InsectSprays$spray=="E"], conf.int=TRUE,
                      warning=FALSE)$conf.int
A[14,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="D"], InsectSprays$count[InsectSprays$spray=="F"], conf.int=TRUE,
                      warning=FALSE)$conf.int
A[15,] <- wilcox.test(InsectSprays$count[InsectSprays$spray=="E"], InsectSprays$count[InsectSprays$spray=="F"], conf.int=TRUE,
                      warning=FALSE)$conf.int

plot(0,0,type="n", ylim=c(0, 15), xlim=c(-20,20), las=1, yaxt='n', 
     xlab="Difference in Count", main="Pairwise Differences in
     Hodges-Lehmann Estimates for InsectSpray Data")
for(k in 1:15) {
    lines(A[k,], c(k,k), lwd=2)
}
```
