...
ggplot(df, aes(x = x, y = y)) +
  ...
  labs(title = "Pearson vs. Spearman correlation",
       subtitle = paste0("Pearson: ", round(pearson_r, 2), 
...
ww <- plogis(zz) - plogis(zz - 2) + rnorm(100,sd = 0.1)

plot(zz, ww, xlab="X", ylab="Y", las=1)
legend("topright", legend=c("Pearson Corr = 0.21", "Spearman Corr = 0.61"),
       bty="n")
```
...
p1 <- paste("Pearson Corr. = ", round(cor(xx1, yy1),3))
p2 <- paste("Spearman Corr. = ", round(cor(xx1, yy1, method="spearman"),3))
par(mfrow=c(1,2))
plot(xx1, yy1, xlab="x", ylab="y", main=paste("Sample Pearson Corr. = ", round(cor(xx1, yy1),3)), las=1)
legend(-1.5,3, legend=c(p1, p2), cex=0.8, bty='n')
p1 <- paste("Pearson Corr. = ", round(cor(xx2, yy2),3))
p2 <- paste("Spearman Corr. = ", round(cor(xx2, yy2, method="spearman"),3))
plot(xx2, yy2, las=1, xlab="x", ylab="y", main=paste("Sample Pearson Corr. = ", round(cor(xx2, yy2),3)))
legend(-1.0,0.25, legend=c(p1, p2), cex=0.8, bty='n')
```
