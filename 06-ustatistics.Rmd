...
par(mfrow=c(1,2))
plot(xx1, yy1, xlab="x", ylab="y", main=paste("Sample Pearson Corr. = ", round(cor(xx1, yy1),4)), las=1)
plot(xx2, yy2, las=1, xlab="x", ylab="y", main=paste("Sample Pearson Corr. = ", round(cor(xx2, yy2),4)))
